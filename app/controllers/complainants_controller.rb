class ComplainantsController < ApplicationController
  ...
  private
    ...
    def complainant_params
      params.require(:complainant).permit(:name, :last_name, :dni, :birthdate, :address, :country_id, :gender_id, :disability_id, :salary, :migrant, :native_id, migrant_attributes: [:country_id, :city_id, :_destroy], complaint_attributes: [:court_id, :conflict_id, :instittution_id, :cost_free_attorney])
    end
end
