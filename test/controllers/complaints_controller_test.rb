...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { complainant_id: @complaint.complainant_id, conflict_id: @complaint.conflict_id, cost_free_attorney: @complaint.cost_free_attorney, court_id: @complaint.court_id, institution_id: @complaint.institution_id } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { complainant_id: @complaint.complainant_id, conflict_id: @complaint.conflict_id, cost_free_attorney: @complaint.cost_free_attorney, court_id: @complaint.court_id, institution_id: @complaint.institution_id } }
