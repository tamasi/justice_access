...
class LawsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create law" do
    assert_difference('Law.count') do
      post laws_url, params: { law: { law_category_id: @law.law_category_id, name: @law.name } }
    end
  ...
  test "should update law" do
    patch law_url(@law), params: { law: { law_category_id: @law.law_category_id, name: @law.name } }
